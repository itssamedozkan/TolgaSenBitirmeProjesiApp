        ...
        lightswitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (lightswitch.isChecked()){
                    ...
                    sendMessage("@Bedroom2Activity:LED-ON");
                }else{
                    sendMessage("@Bedroom2Activity:LED-OFF");
                }
            }
        ...
        curtainswitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (curtainswitch.isChecked()){
                    ...
                    sendMessage("@Bedroom2Activity:CURTAIN-ON");
                }else{
                    sendMessage("@Bedroom2Activity:CURTAIN-OFF");
                }
            }
        ...
        aircondswitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (aircondswitch.isChecked()){
                    ...
                    sendMessage("@Bedroom2Activity:AIRCON-ON");
                }else{
                    sendMessage("@Bedroom2Activity:AIRCON-OFF");
                }
            }
        ...
        thiefswitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (thiefswitch.isChecked()){
                    ...
                    sendMessage("@Bedroom2Activity:BURGLAR-ON");
                }else{
                    sendMessage("@Bedroom2Activity:BURGLAR-OFF");
                }
            }
